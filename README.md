...
In the cheatsheet, the Package Id of the contract you just published and the Object Ids (generated by the Id Generator) you need when creating certain entities are already filled in for you. The parameters you need to fill in have placeholder text containing their type and meaning (name). You can copy these commands, modify them as needed, and execute them directly in a terminal.
