...
import org.test.suitestproj1.sui.contract.orderv2.OrderV2ItemQuantityUpdated;
import org.test.suitestproj1.sui.contract.orderv2.OrderV2EstimatedShipDateUpdated;
import org.test.suitestproj1.sui.contract.orderv2.OrderShipGroupAdded;
import org.test.suitestproj1.sui.contract.orderv2.OrderShipGroupQuantityCanceled;
import org.test.suitestproj1.sui.contract.orderv2.OrderShipGroupItemRemoved;
...
public class DomainBeanUtils {
    ...
    public static org.test.suitestproj1.domain.Day toDay(Day contractDay) {
        if (contractDay == null) {
            return null;
        }
        org.test.suitestproj1.domain.Day day = new org.test.suitestproj1.domain.Day();
    ...
    public static org.test.suitestproj1.domain.Day toDay(DayForEvent contractDay) {
        if (contractDay == null) {
            return null;
        }
        org.test.suitestproj1.domain.Day day = new org.test.suitestproj1.domain.Day();
    ...
    public static org.test.suitestproj1.domain.domainname.DomainNameId toDomainNameId(DomainNameId contractDomainNameId) {
        if (contractDomainNameId == null) {
            return null;
        }
        org.test.suitestproj1.domain.domainname.DomainNameId domainNameId = new org.test.suitestproj1.domain.domainname.DomainNameId();
    ...
    public static org.test.suitestproj1.domain.domainname.DomainNameId toDomainNameId(DomainNameIdForEvent contractDomainNameId) {
        if (contractDomainNameId == null) {
            return null;
        }
        org.test.suitestproj1.domain.domainname.DomainNameId domainNameId = new org.test.suitestproj1.domain.domainname.DomainNameId();
    ...
    public static org.test.suitestproj1.domain.Month toMonth(Month contractMonth) {
        if (contractMonth == null) {
            return null;
        }
        org.test.suitestproj1.domain.Month month = new org.test.suitestproj1.domain.Month();
    ...
    public static org.test.suitestproj1.domain.Month toMonth(MonthForEvent contractMonth) {
        if (contractMonth == null) {
            return null;
        }
        org.test.suitestproj1.domain.Month month = new org.test.suitestproj1.domain.Month();
    ...
    public static org.test.suitestproj1.domain.Year toYear(Year contractYear) {
        if (contractYear == null) {
            return null;
        }
        org.test.suitestproj1.domain.Year year = new org.test.suitestproj1.domain.Year();
        year.setNumber(contractYear.getFields().getNumber());
        year.setCalendar(contractYear.getFields().getCalendar());
        return year;
    }

    public static org.test.suitestproj1.domain.Year toYear(YearForEvent contractYear) {
        if (contractYear == null) {
            return null;
        }
        org.test.suitestproj1.domain.Year year = new org.test.suitestproj1.domain.Year();
