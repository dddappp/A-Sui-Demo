...
import org.test.suitestproj1.specialization.NullReadOnlyProxyGenerator;
import org.test.suitestproj1.specialization.ReadOnlyProxyGenerator;
...
//    }
    ...
    public LocalSessionFactoryBean hibernateSessionFactory() throws IOException {
        ...
        sessionFactory.setPackagesToScan("org.test.suitestproj1.*"); //add annotation mappings
