...
module sui_test_proj1::order_ship_group {
    use std::string::String;
    use sui::table;
    use sui::tx_context::TxContext;
    use sui_test_proj1::order_item_ship_group_association::{Self, OrderItemShipGroupAssociation};
    ...
    friend sui_test_proj1::order_v2;
