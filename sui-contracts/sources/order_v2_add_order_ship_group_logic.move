module sui_test_proj1::order_v2_add_order_ship_group_logic {
    use std::string::String;

    use sui::tx_context::TxContext;
    use sui_test_proj1::order_v2;
    use sui_test_proj1::order_v2_item;
    use sui_test_proj1::order_ship_group;
    use sui_test_proj1::order_item_ship_group_association;
    use sui_test_proj1::order_ship_group_added;

    friend sui_test_proj1::order_v2_aggregate;
