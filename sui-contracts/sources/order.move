...
module sui_test_proj1::order {
    ...
    use sui_test_proj1::order_item::{Self, OrderItem};
    friend sui_test_proj1::order_create_logic;
    friend sui_test_proj1::order_remove_item_logic;
    friend sui_test_proj1::order_update_item_quantity_logic;
