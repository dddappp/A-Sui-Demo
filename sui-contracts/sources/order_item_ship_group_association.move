...
module sui_test_proj1::order_item_ship_group_association {
    use std::string::String;
    use sui::table;
    use sui::tx_context::TxContext;
    use sui_test_proj1::day::Day;
    use sui_test_proj1::order_item_ship_group_assoc_subitem::{Self, OrderItemShipGroupAssocSubitem};
    friend sui_test_proj1::order_v2_create_logic;
    friend sui_test_proj1::order_v2_remove_item_logic;
    friend sui_test_proj1::order_v2_update_item_quantity_logic;
    friend sui_test_proj1::order_v2_update_estimated_ship_date_logic;
    friend sui_test_proj1::order_v2_add_order_ship_group_logic;
    friend sui_test_proj1::order_v2_cancel_order_ship_group_quantity_logic;
    friend sui_test_proj1::order_v2_remove_order_ship_group_item_logic;
    friend sui_test_proj1::order_v2_remove_order_ship_group_logic;
    friend sui_test_proj1::order_ship_group;
